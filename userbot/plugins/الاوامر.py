...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/cr_source) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/cr_source) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 𓆪"
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/RallsThon) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/cr_source) 𓆪\n **⌔╎قائـمه اوامر الردود :** \n⪼ `.اضف رد ` الامر ثم اسم الرد بالرد ع كلمة الرد \n⪼ `.حذف رد ` \n⪼ `.حذف الردود `\n⪼ `.الردود `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/cr_source) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 𓆪")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘) 🧸♥️𓆪\n**𓍹━─━─━─━──𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘━─━─━─━𓍻**\n **𓄂**╺  𝑫𝑬𝑽 ❶╰──► @dr_criss ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❷╰──► @cr_source ༗")
...
async def _(Ralls):
    await eor(Ralls, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘](t.me/cr_source) 🗑♻️𓆪\n**𓍹━─━─━─━─𝐑𝐀𝐈𝐈𝐒─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘 - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @dr_criss ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @@bar_lo0o0 ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 3 ↬ @@CR_Amr_Sabry ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 4 ↬ @wjj_u ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            alive,
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @dr_criss ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @bar_lo0o0 ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @cr_amr_sabry ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @bar_lo0o0 ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧ𝗖𝗥𝗜𝗦𝗧𝗜𝗡𝗘ⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )
