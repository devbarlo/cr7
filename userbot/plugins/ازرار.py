...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/dr_criss> [بوت كرستين]<buttonurl:https://t.me/cr_source> [اوامر السورس]<buttonurl:https://t.me/cr_source>`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/dr_criss> [بوت كرستين]<buttonurl:https://t.me/cr_source> [اوامر السورس]<buttonurl:https://t.me/cr_source>`\
    "
    }
)
