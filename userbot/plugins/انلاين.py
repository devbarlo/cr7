...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid: 
            ...
            reply_pop_up_alert = "⌔∮ عليك الحصول على بوت كريستين  للحصول عليه اذهب الى @cr_source. "
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "⌔∮ عليك الحصول على بوت كرستين للحصول عليه اذهب الى @cr_source. "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "⌔∮ عليك الحصول على كرستين ثون للحصول عليه اذهب الى @cr_source. "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
